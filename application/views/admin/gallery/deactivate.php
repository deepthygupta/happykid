            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo sprintf(lang('blog_deactivate_question')); ?></h3>
                    </div>
                    <div class="box-body">
                        <?php echo form_open('admin/blog/deactivate/' . $blog_id, array('class' => 'form-horizontal', 'id' => 'form-status_user')); ?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <?php echo form_hidden(array('blog_id' => $blog_id)); ?>
                                <div class="btn-group">
